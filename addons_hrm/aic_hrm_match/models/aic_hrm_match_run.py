...
class AicHrmMatchRun(models.Model):
    ...
    _reference_uniq = models.Constraint(
        'unique (reference)',
        'That ranking reference already exists.',
    )
...
class AicHrmMatchCandidate(models.Model):
    ...
    _run_employee_uniq = models.Constraint(
        'unique (run_id, employee_id)',
        'That person already has a result in this ranking.',
    )
...
class AicHrmMatchScoreLine(models.Model):
    ...
    _candidate_criterion_uniq = models.Constraint(
        'unique (candidate_id, criterion_code)',
        'That criterion is already scored for this candidate.',
    )
...
class AicHrmMatchIdentity(models.Model):
    ...
    _run_candidate_uniq = models.Constraint(
        'unique (run_id, candidate_id)',
        'That candidate already has an identity in this ranking.',
    )
    _run_employee_uniq = models.Constraint(
        'unique (run_id, employee_id)',
        'That person already appears once in this ranking.',
    )
